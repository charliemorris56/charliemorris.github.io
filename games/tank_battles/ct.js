...
ct.inputs.addAction('GreenMoveRight', [{"code":"keyboard.KeyD"}]);
ct.inputs.addAction('GreenMoveLeft', [{"code":"keyboard.KeyA"}]);
ct.inputs.addAction('GreenJump', [{"code":"keyboard.KeyW"}]);
ct.inputs.addAction('GreenDown', [{"code":"keyboard.KeyS"}]);
ct.inputs.addAction('OrangeShoot', [{"code":"keyboard.ShiftRight"}]);
ct.inputs.addAction('GreenShoot', [{"code":"keyboard.Space"}]);
ct.inputs.addAction('OrangeMoveLeft', [{"code":"keyboard.ArrowLeft"}]);
ct.inputs.addAction('OrangeJump', [{"code":"keyboard.ArrowUp"}]);
ct.inputs.addAction('OrangeDown', [{"code":"keyboard.ArrowDown"}]);
ct.inputs.addAction('OrangeMoveRight', [{"code":"keyboard.ArrowRight"}]);
